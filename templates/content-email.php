...
<html dir="<?php echo is_rtl() ? 'rtl' : 'ltr'?>">
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
        <div id="email_container" dir="<?php echo is_rtl() ? 'rtl' : 'ltr'?>" style="background-color: #f5f5f5; margin: 0; padding: 0; -webkit-text-size-adjust: none !important; width: 100%;">
            <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
                <tr>
                    <td align="center" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_container" style="box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important; background-color: #fdfdfd; border: 1px solid #dcdcdc; border-radius: 3px !important;">
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header" style='background-color: <?php echo $email_header_bg_color; ?>; border-radius: 3px 3px 0 0 !important; color: <?php echo $email_header_text_color; ?>; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif;'>
                                        <tr>
                                            <td id="header_wrapper" background="<?php if($email_header_image) echo $email_header_image; ?>" bgcolor="<?php echo $email_header_bg_color; ?>" width="100%" height="120" valign="center" style="background-position: center 15px; background-size: auto; background-repeat: no-repeat;">
                                                <!--[if gte mso 9]>
                                                ...
                                                <div style="padding: 20px 48px; display: block;">
                                                    <h1 style='color: <?php echo $email_header_text_color; ?>; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 50px 0 16px 0; text-align: center; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased; display: block;'>
                                                        <?php
                ...
                <tr>
                    <td valign="top" style="padding: 0; -webkit-border-radius: 6px;">
                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                            <tr>
                                <td colspan="2" valign="middle" id="footer_text" style="padding: 0; -webkit-border-radius: 6px; border: 0; color: #99b1c7; font-family: Arial; font-size: 12px; line-height: 125%; text-align: center;">
                                    <?php
